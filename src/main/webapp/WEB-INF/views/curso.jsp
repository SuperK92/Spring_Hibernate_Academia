...
<body>
	...
	<form:form action="${addAction}" commandName="curso">
		<table>
			...
			<tr>
				<td><form:label path="familia">
						<spring:message text="Familia" />
					</form:label></td>
				<td><form:select path="familia.id" var="familia">
						<form:option value="0" label="-- Elegir Familia--" />
						<form:options items="${listaFamilias}" itemValue="id"
							itemLabel="nombre" />
					</form:select></td>
			</tr>
			<!-- 	<tr> -->
			...
			<tr>
				...
				<td><form:select path="profesor.id" var="profesor">
						<form:option value="0" label="-- Elegir Profesor--" />
						<form:options items="${listaProfesores}" itemValue="id"
							itemLabel="nombre" />
					</form:select></td>
			</tr>
